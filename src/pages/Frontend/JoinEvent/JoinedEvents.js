...
<div className="container">
  <div className="row">
    ...
    <div className="row">
    <div className="col py-3 ">
      <p className='mb-0 text-center fw-bold fs-1' >You did not created any Event </p>
          </div>
        </div>
          </div>
</div>
...
<div className="card-body">
  <p className="card-title"> <span className='text-warning'> User email : </span>{event.joinedBy.email}</p>
